...
## 0.2 發布後文件補充（2026-09-26）

- 新增[模型呼叫盤點](docs/model-calls.md)，說明設定來源、背景工作及快取／額度的邊界。
- 補上沒有回覆的診斷順序、原生 CLI／結構化格式相容、日期與查詢脈絡、空接力抑制及人工隱私驗收。
- 修正 Party action 列舉與共享脈絡的呼叫次數描述；程式、設定及既有發布標籤不變。
