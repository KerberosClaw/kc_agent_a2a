# SQLite schema appendix

[Documentation index](index.md) · [Data model](data-model.md)

Generated by initializing fresh synthetic stores and reading `sqlite_master`. Includes current tables and explicit indexes; migration-only intermediate tables are omitted. Real state must never be used to regenerate public documentation.
...
## digest_hook supplemental tables
...
## continuity_hook supplemental tables
